...
class OnlineState {
  ...
  OnlineState copyWith({
    ...
    return OnlineState(
      ...
      targetHands: targetHands ?? this.targetHands,
  ...
  void _handleMessage(Map<String, dynamic> msg) {
    ...
    switch (type) {
      ...
      case 'stateUpdate':
        ...
        final stateTargetH = payload['targetHands'] as int?;
        state = state.copyWith(
          gameState: payload,
          ...
          targetHands: stateTargetH ?? state.targetHands,
        );
        break;
      case 'handScored':
      ...
      case 'reconnected':
        ...
        if (reconnectGameState != null) {
          ...
          reconnectTargetH = reconnectGameState['targetHands'] as int?;
        ...
        state = state.copyWith(
          ...
          targetHands: reconnectTargetH ?? state.targetHands,
          clearError: true,
        );
        break;
      case 'playerReconnected':
        state = state.copyWith(opponentDisconnected: false, clearError: true);
        break;
      ...
      case 'playerLeft':
        ...
        state = state.copyWith(
          errorMessage: reason == 'timeout'
              ? 'Opponent left the game (timeout)'
